...
const MissedHero = () => {
    return (
        <div className='flex lg:flex-row flex-col-reverse justify-center lg:items-stretch items-center w-full   lg:px-40 px-8  '>
            ...
            <div className='flex flex-col relative w-full gap-6'>
                <div className='bg-blue-500 text-[#fff] rounded-3xl rounded-bl-none py-3 px-2 lg:absolute -left-[10%]'>
                    <h2 className='text-5xl'>Oops you missed</h2>
                    <p className='text-2xl'> the Kidpreneur Bootcamp Webinar</p>
                </div>
                <div className='mt-28 lg:w-[56%] w-full lg:ml-8 leading-[2] text-2xl'>
                ...
                <div className='ml-8 text-2xl py-8'>
                    <p>
